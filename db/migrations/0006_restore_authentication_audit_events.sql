/*
    Forward-only correction: preserve every event accepted by migration 0003 while adding
    terminal verification events. Migration 0005 omitted existing administration/MFA values.
*/
